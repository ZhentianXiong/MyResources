...
public class BlockController {
    ...
    @GetMapping("/create")
    @ApiOperation(value = "创建一个区块", notes = "创建一个新区块", httpMethod = "GET", response = BaseData.class)
    public BaseData create(@ApiParam(name = "content", value = "区块链内容", required = true)  @RequestParam(value = "content") String content,
                           @ApiParam(name = "domain", value = "域名", required = true)  @RequestParam(value = "domain") String domain,
                           @ApiParam(name = "ip", value = "IP地址", required = true)  @RequestParam(value = "ip") String ip,
                           @ApiParam(name = "owner", value = "拥有者公钥地址", required = true)  @RequestParam(value = "owner") String owner) throws Exception {
        InstructionBody instructionBody = new InstructionBody();
        instructionBody.setOperation(Operation.ADD);
        instructionBody.setTable("message");
        instructionBody.setJson("{\"content\":\"" + content + "\"}");
        instructionBody.setJson("{\"content\":\"" + content + "\" ,\"domain\":\"" + domain + "\" ,\"ip\":\"" + ip + "\" ,\"owner\":\"" + owner + "\"  }");
        instructionBody.setPublicKey(publicKey);
        instructionBody.setPrivateKey(privateKey);
        Instruction instruction = instructionService.build(instructionBody);
    ...
    @ApiOperation(value = "查询区块链内容", notes = "查询区块链内容", httpMethod = "GET", response = BaseData.class)
    @GetMapping("maps/ip")
    public BaseData searchIP(@ApiParam(name = "domain", value = "域名", required = true)  @RequestParam(value = "domain",required = true) String domain) {
        return ResultGenerator.genSuccessResult(messageManager.findByDomain(domain));
    }
     ...
     */
    @ApiOperation(value = "查询区块链内容", notes = "查询区块链内容", httpMethod = "GET", response = BaseData.class)
    @GetMapping("maps/domain")
    public String searchDomain(@ApiParam(name = "ip", value = "IP地址", required = true)  @RequestParam(value = "ip",required = true) String ip) {
        return ResultGenerator.genSuccessResult(messageManager.findByIp(ip)).toString();
    }
